...
KBUILD_CPPFLAGS += -DOPLUS_ARCH_EXTENDS
CFLAGS_KERNEL += -DOPLUS_ARCH_EXTENDS
CFLAGS_MODULE += -DOPLUS_ARCH_EXTENDS
...
KBUILD_CPPFLAGS += -DOPLUS_FEATURE_AUDIO_FTM
CFLAGS_KERNEL += -DOPLUS_FEATURE_AUDIO_FTM
CFLAGS_MODULE += -DOPLUS_FEATURE_AUDIO_FTM
...
KBUILD_CFLAGS += -DOPLUS_FEATURE_PXLW_IRIS5
KBUILD_CPPFLAGS += -DOPLUS_FEATURE_PXLW_IRIS5
CFLAGS_KERNEL += -DOPLUS_FEATURE_PXLW_IRIS5
CFLAGS_MODULE += -DOPLUS_FEATURE_PXLW_IRIS5

KBUILD_CFLAGS += -DOPLUS_FEATURE_TP_BASIC
KBUILD_CPPFLAGS += -DOPLUS_FEATURE_TP_BASIC
CFLAGS_KERNEL += -DOPLUS_FEATURE_TP_BASIC
CFLAGS_MODULE += -DOPLUS_FEATURE_TP_BASIC

KBUILD_CFLAGS += -DOPLUS_FEATURE_UFSPLUS
KBUILD_CPPFLAGS += -DOPLUS_FEATURE_UFSPLUS
CFLAGS_KERNEL += -DOPLUS_FEATURE_UFSPLUS
CFLAGS_MODULE += -DOPLUS_FEATURE_UFSPLUS
